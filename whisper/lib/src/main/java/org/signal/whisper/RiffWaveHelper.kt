...
fun decodeWaveInputStream(stream: InputStream): FloatArray {
...
fun encodeWaveOutputStream(stream: OutputStream, data: ShortArray) {
    stream.use {
...
fun decodeWaveFile(file: File): FloatArray {
  return decodeWaveInputStream(file.inputStream())
}

fun encodeWaveFile(file: File, data: ShortArray) {
  encodeWaveOutputStream(file.outputStream(), data)
}
