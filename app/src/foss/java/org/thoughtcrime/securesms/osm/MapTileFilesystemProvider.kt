...
private val TAG = Log.tag(MapTileFilesystemProvider::class.java)

class MapTileFilesystemProvider(
  ...
  override fun getName(): String = "File System Cache Provider"

  override fun getThreadGroupName(): String = "filesystem"
